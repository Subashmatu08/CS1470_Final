...
def preprocess_video(input_video_path, output_video_path, face_predictor_path, mean_face_path):
    ...
    write_video_ffmpeg(rois, roi_path, "/opt/homebrew/bin/ffmpeg")
    ...
    cmd = "/opt/homebrew/bin/ffmpeg" + " -i " + input_video_path+'/'+output_video_path + " -f wav -vn -y " + audio_fn + ' -loglevel quiet'
